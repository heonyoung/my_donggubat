                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    ...
                                    settings: RouteSettings(
                                      arguments: {
                                        'title': noticeTitles[0],
                                        'date': noticeInfo[0]['date']!,
                                        'view': noticeInfo[0]['view']!,
                                        'index': 0,
                                      },
                                    ),
                                  ),
                              ...
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    ...
                                    settings: RouteSettings(
                                      arguments: {
                                        'title': noticeTitles[1],
                                        'date': noticeInfo[1]['date']!,
                                        'view': noticeInfo[1]['view']!,
                                        'index': 1,
                                      },
                                    ),
                                  ),
                                ...
                                MaterialPageRoute(
                                  ...
                                  settings: RouteSettings(
                                    arguments: {
                                      ...
                                      'date': noticeInfo[2]['date']!,
                                      'view': noticeInfo[2]['view']!,
                                      'index': 2,
                                    },
                                  ),
                                ),
